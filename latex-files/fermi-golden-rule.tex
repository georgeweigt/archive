...
Let $\psi_1(x)$ be an initial eigenstate and let $\psi_2(x)$ be a final eigenstate.
Let $\Psi(x,t)$ be the following linear combination of $\psi_1(x)$ and $\psi_2(x)$.
\begin{equation*}
\Psi(x,t)=c_1(t)\psi_1(x)\exp(-i\omega_1t)+c_2(t)\psi_2(x)\exp(-i\omega_2t)
\end{equation*}

Solve for $c_2(t)$ and find the transition rate $\Gamma_{1\rightarrow2}$.
